...
// ======================== ADC ========================= //
inline bool in_range(int16_t value, int16_t target, int16_t spread) {
  bool a = (value < (target + spread));
  bool b = (value > (target - spread));
  return (a && b);
}
...
const uint8_t cfg2     = 0b10001000;

volatile bool adcstate;
void ICACHE_RAM_ATTR adcint() {
  adcstate = true;
}
...
void setup() {
  ...
  writeByte2(ADS1115_ADDRESS, ADS_CONFIG, cfg1_chJX, cfg2);
  ...
  if (adcstate) {
    ...
    switch (adc_active_channel) {
      case 0:
        ...
        break;
      case 1:
        writeByte2(ADS1115_ADDRESS, ADS_CONFIG, cfg1_chJY, cfg2);
        break;
      case 2:
        writeByte2(ADS1115_ADDRESS, ADS_CONFIG, cfg1_chTRG, cfg2);
        break;
      case 3:
        writeByte2(ADS1115_ADDRESS, ADS_CONFIG, cfg1_chBTN, cfg2);
        break;
    }
    adcstate = false;
    ++adc_counter;
